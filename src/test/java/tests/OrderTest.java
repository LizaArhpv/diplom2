...
public class OrderTest extends BaseTest {
    ...
    public void localSetUp() {
        ...
        CreateUsers userForOrder = RandomUsers.generate();
        Response response = userSteps.register(userForOrder);
        accessToken = response.path("accessToken");

        LoginUsers loginUsers = new LoginUsers(userForOrder.getEmail(), userForOrder.getPassword());
        userSteps.login(loginUsers);
